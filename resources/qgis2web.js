...
map.getView().fit([3633530.618936, -1848760.385393, 4104827.515085, -1608929.836856], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MALAWI: 2023 Emergency District, Camp and Warehouse Location </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (514 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map provides a spatial overview of Malawi’s districts affected by floods, highlighting the locations of displacement camps and warehouse sites used for emergency response. It serves as a visual tool for humanitarian coordination, aiding in the assessment of affected areas, resource distribution, and logistical planning. By integrating geographic data on flood-impacted regions, temporary shelters, and storage facilities, the map supports decision-making processes for disaster response and recovery efforts';
            }
